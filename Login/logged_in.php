...
<body>
	...
	<div id="doortool" style="text-align:center">
		...
		<table id="passwordtool">
			<tr>
				<th colspan="5">Account Management</th>
			</tr>
			<tfoot>
				<tr>
				...
				<tr>	
					<form action='' method='post'>
						<td colspan="5">
							<button id="addbtn" name="addbtn" style="width:100%">Add User</button>
						</td>
					</form>
				</tr>
				<tr>	
					<form action='' method='post'>
						<td colspan="5">
							<button id="rembtn" name="rembtn" style="width:100%">Remove User</button>
						</td>
					</form>
				</tr>
			</tfoot>
